...
const content = [
  ...
  },
  {
    ...
    body: 'A) Information you provide\n\nAccount and verification\n• Name, username/handle\n• Phone number (optional)\n• Email address\n• School affiliation\n• Password or authentication token (depending on login method)\n\nProfile information\n• Profile photo (optional)\n• Bio, graduation year, and other profile fields you choose to fill in (optional)\n\nCarpool content and activity\n• Ride/carpool posts you create (pickup area, destination area, date/time, seats, suggested cost-sharing amount, notes)\n• Requests/responses to rides, confirmations, and cancellations\n• Messages and other communications sent through the Service\n• Reports you submit (safety reports, content reports, support requests)\n\nCustomer support\n• Information you send to us (including attachments) when you contact support.\n\nB) Information collected automatically\n\nDevice and usage information\n• Device type, OS version, app version\n• IP address, device identifiers (as permitted by your device settings), language\n• Log data, crash reports, performance diagnostics\n• Approximate or precise location (only if you grant permission)\n• Location may be used to show relevant carpools, estimate distance, and support safety features. We request permission before using location and you can change it in your device settings.\n\nCookies and similar technologies\n• If we operate a web site associated with the Service, it may use cookies or similar technologies for authentication and basic analytics.',
  },
  {
    title: '3. How We Use Information',
    body: 'We use information to:\n• Provide and maintain the Service (account creation, verification, matching riders and drivers, messaging)\n• Personalize and improve the Service (for example, show relevant rides)\n• Safety, integrity, and trust (detect abuse, investigate reports, enforce rules)\n• Communicate with you (service updates, security notices, support replies)\n• Analytics and performance (debugging, crash prevention, feature improvement)\n• Legal compliance (respond to lawful requests, prevent fraud, protect rights)\n\nWe do not use personal data for cross-app tracking without permission, and if we ever engage in "tracking" as defined by Apple, we will request permission using Apple\'s required framework.',
  },
  {
    title: '4. How We Share Information',
    body: 'A) Sharing with other users (core to the Service)\n\nDepending on your settings and the features you use, other users may see:\n• Your profile (name/handle, photo, campus, and other profile fields you chose to make visible)\n• Your ride posts and ride-related details\n• Messages you send and receive\n• Limited verification signals (for example, "verified student" status)\n\nB) Sharing with service providers\n\nWe may share information with vendors who help us run the Service, such as:\n• Cloud hosting and databases\n• Email delivery and verification services\n• Maps and location services\n• Analytics, logging, and crash reporting\n\nThese providers are permitted to use information only to provide services to us (subject to contractual restrictions).\n\nC) Legal, safety, and enforcement sharing\n\nWe may disclose information if we believe it is reasonably necessary to:\n• Comply with law or valid legal process\n• Protect the safety, rights, or property of users, SchoolBus, or the public\n• Investigate fraud, security, or technical issues\n• Enforce our Terms\n\nD) Business transfers\n\nIf SchoolBus is involved in a merger, acquisition, financing, reorganization, bankruptcy, or sale of assets, information may be transferred as part of that transaction.',
  },
  {
    title: '5. Your Choices and Controls',
    body: 'You can:\n• Edit profile information in the app\n• Control location permissions in your device settings\n• Control push notifications in your device settings\n• Request access, deletion, or correction of your account data by contacting us',
  },
  {
    title: '6. Data Retention',
    body: 'We keep information as long as necessary to:\n• Provide the Service\n• Comply with legal obligations\n• Resolve disputes and enforce agreements\n\nRetention periods vary depending on the type of data and why we need it (for example, safety reports may be retained longer than basic logs).',
  },
  {
    title: '7. Security',
